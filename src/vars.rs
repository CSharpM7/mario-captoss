pub const FIGHTER_MARIO_STATUS_KIND_LAST: i32 = 0x15e; //0x1e3;
...
pub const FIGHTER_MARIO_STATUS_KIND_CAPCATCH: i32 = FIGHTER_MARIO_STATUS_KIND_LAST+4; //+3 causes a crash
